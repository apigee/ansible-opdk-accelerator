...
[setup-control-server.yml](setup.yml) script enables you to setup an
...
role. The [backup-control-server.yml](backup.yml) script backs up to either a default folder or a provided folder on your local file system.
